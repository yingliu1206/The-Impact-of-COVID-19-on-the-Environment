...
```{r}
RecordDataPath="/Users/LiuYing/Desktop/GU/2020-fall/ANLY-501-01/dataset/data/covid19_by_weather.csv"
...
```{r}
fitR <- rpart(RecordDF_Cat_DT_Train$Label ~ X1.week...increase.cat + ConfirmedSum.cat + DeathsSum.cat + RecoveredSum.cat, data = RecordDF_Cat_DT_Train, method="class", control = rpart.control(minsplit = 1, 
                                                              minbucket = 1, 
                                                                     cp = 0.001)
)
summary(fitR)
...
## VIS..................
fancyRpartPlot(fitR, tweak=1.2)
fitR$variable.importance
```
