...
########################################################################################
filenameNum="/Users/LiuYing/Desktop/GU/2020-fall/ANLY-501-01/dataset/data/covid19_by_weather.csv"
...
ymap=ymap.replace("windgust below average", 1)
ymap=ymap.replace("windgust at or above average", 0)
...
sns.heatmap(cnf_matrix.T, square=True, annot=True, fmt='d', 
            xticklabels=["windgust at or above average", "windgust below average"], yticklabels=["windgust at or above average", "windgust below average"])
