...
```{r}
fitR2 <- svm(RecordDF_Cat_DT_Train$Label ~ X1.week...increase.cat + ConfirmedSum.cat + DeathsSum.cat + RecoveredSum.cat, data = RecordDF_Cat_DT_Train, kernel="polynomial", cost=.1, 
               scale=FALSE
)
summary(fitR2)
```
...
## VIS..................
plot(RecordDF_label, main = "True labels", col = c("dark red", "pink"))
