...
########################################################################################
filenameNum="/Users/LiuYing/Desktop/GU/2020-fall/ANLY-501-01/dataset/data/covid19_by_wqi.csv"
...
ymap=ymap.replace("WQI below average", 1)
ymap=ymap.replace("WQI at or above average", 0)
...
sns.heatmap(cnf_matrix.T, square=True, annot=True, fmt='d', 
            xticklabels=["WQI at or above average", "WQI below average"], yticklabels=["WQI at or above average", "WQI below average"])
